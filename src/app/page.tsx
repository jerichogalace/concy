  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-sky-50 to-white flex flex-col safe-area-inset">
      ...
      {isSubmitted ? (
          ...
          <Card className="w-full max-w-md border-green-200 shadow-lg">
            <CardContent className="pt-6 pb-6 sm:pt-8 sm:pb-8 text-center">
              ...
              <Button 
                ...
                className="bg-sky-700 hover:bg-sky-800 h-12 text-base w-full sm:w-auto px-8"
              >
        ...
        /* Main Form */
        <main className="flex-1 p-3 sm:p-4 py-4 sm:py-8 pb-safe">
              ...
              <CardContent className="pt-4 sm:pt-6 px-4 sm:px-6 pb-4 sm:pb-6">
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 sm:space-y-5">
                  ...
                  <div className="space-y-1.5 sm:space-y-2">
                    ...
                    <Select
                      value={visitorType}
                      onValueChange={(value: VisitorType) => setValue('visitorType', value)}
                    >
                  ...
                  {/* Contact Number - Optional (Numbers Only) */}
                  <div className="space-y-1.5 sm:space-y-2">
                    ...
                    {errors.contactNumber && (
                      <p className="text-xs sm:text-sm text-red-500">{errors.contactNumber.message}</p>
                    )}
                  </div>
                  ...
                  <div className="space-y-1.5 sm:space-y-2">
                    ...
                    <Select
                      value={concernType}
                      onValueChange={(value: ConcernType) => setValue('concernType', value)}
                    >
                      <SelectTrigger className="h-11 sm:h-12 text-base rounded-lg">
                  ...
                  {/* Concern Details with Attachments Inside */}
                  <div className="space-y-1.5 sm:space-y-2">
                    ...
                    {/* Combined container that looks like a textarea with attachments inside */}
                    <div className="border rounded-lg bg-white overflow-hidden focus-within:ring-2 focus-within:ring-sky-500 focus-within:border-sky-500">
                      ...
                      <Textarea
                        ...
                        className="min-h-[100px] sm:min-h-[120px] text-base resize-none border-0 focus-visible:ring-0 rounded-none"
                        {...register('concernDetails')}
                      />
                      
                      {/* Attachments Section Inside the Box */}
                        ...
                        <div className="p-2 border-b bg-white">
                          <div className="flex flex-wrap items-center gap-2">
                            ...
                            <Button
                              ...
                              variant="ghost"
                              size="sm"
                              className="h-8 text-xs px-2 text-purple-700 hover:bg-purple-50"
                            ...
                            <Button
                              ...
                              variant="ghost"
                              size="sm"
                              className="h-8 text-xs px-2 text-blue-700 hover:bg-blue-50"
                          ...
                          {(linkError || uploadError) && (
                            <p className="text-[10px] text-red-500 mt-1">{linkError || uploadError}</p>
                          )}
                          
                          {/* Size Info */}
                          <p className="text-[9px] text-gray-400 mt-1">
                            Max 10MB/file, 30MB total • Images, PDF, DOC, XLS, TXT
                          </p>
                        </div>
                          ...
                          <div className="p-2 space-y-1.5">
                            ...
                            <div className="flex flex-wrap gap-1.5">
                              {attachments.map((attachment) => (
                                <div
                                  key={attachment.id}
                                  className={`flex items-center gap-1.5 px-2 py-1 rounded text-xs ${getAttachmentColor(attachment.type)}`}
                                >
                    ...
                    {errors.concernDetails && (
                      <p className="text-xs sm:text-sm text-red-500">{errors.concernDetails.message}</p>
                    )}
                  </div>
                  ...
                  <div className="space-y-1.5 sm:space-y-2">
                    ...
                    <Textarea
                      ...
                      className="min-h-[70px] sm:min-h-[80px] text-base resize-none rounded-lg"
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 pt-4">
                    <Button
                      type="submit"
                      className="flex-1 h-12 text-base bg-sky-700 hover:bg-sky-800 rounded-lg touch-manipulation"
                    ...
                    <Button
                      type="button"
                      variant="outline"
                      className="flex-1 h-12 text-base rounded-lg touch-manipulation"
                      onClick={handleClear}
                    >
                      Clear Form
                    </Button>
                  ...
                  <div className="text-center pt-2">
                    <Link href="/admin" className="text-sm text-sky-700 hover:text-sky-800 underline">
                      Admin Login
                    </Link>
                  </div>
                </form>
